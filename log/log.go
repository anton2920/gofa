...
func Logf(level Level, format string, args ...interface{}) {
	...
	fmt.Fprintf((*bytes.Buffer)(pointers.UnsafeNoescape(unsafe.Pointer(&buffer))), " %5s ", Level2String[level])
	fmt.Fprintf((*bytes.Buffer)(pointers.UnsafeNoescape(unsafe.Pointer(&buffer))), format, args...)
