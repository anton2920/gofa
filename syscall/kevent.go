...
const (
	...
	EVFILT_EMPTY    = -13 /* empty send socket buf */
	...
	NOTE_CLOSE       = 0x0100 /* file closed, fd did not allowed write */
	NOTE_CLOSE_WRITE = 0x0200 /* file closed, fd did allowed write */
	...
	NOTE_ABSTIME  = 0x00000010 /* timeout is absolute */
)
